...
g++ -std=c++17 -Wall -Wextra -O2 -Iinclude -Ithird_party/raylib/src src/main.cpp src/GameState.cpp src/Entities/Entity.cpp src/Entities/Player.cpp src/Entities/Enemy.cpp src/Entities/Skill.cpp src/Systems/ElementalSystem.cpp src/Systems/WeatherSystem.cpp src/Systems/CombatSystem.cpp src/Systems/RewardSystem.cpp src/Systems/MapSystem.cpp src/Core/Localization.cpp src/Renderer/ParticleSystem.cpp src/Renderer/FontManager.cpp src/Renderer/WeatherRenderer.cpp src/Renderer/CombatRenderer.cpp src/Renderer/RewardRenderer.cpp src/Renderer/MapRenderer.cpp src/Renderer/UIRenderer.cpp -L. -lraylib -lopengl32 -lgdi32 -lwinmm -o RougelikeWithAgy.exe
